                ...
                <div className="col-9  mt-5">
                    ...
                    <div className="col-12 mt-2 border ">
                        ...
                        <div className='mx-5 m-4'>
                            ...
                            <br />
                            <span className=' ' style={{ marginLeft: '38px' }}>Title </span>
                            <input type="text" className='mx-3 mt-2 w-25'/>
                            <span className=' ' style={{ marginLeft: '247px' }}>
                            ...
                            <input type="text" className=' mt-2 w-25' style={{ marginLeft: '12px' }} />
                    ...
                    <div className=' mt-2 mb-2'>
                        ...
                        <Link to='/catlist'><button style={{ background: '#00ACFF', color: 'white', height: '40px', margin: '10px', marginLeft: '25px', border: '5px solid #00ACFF', borderRadius: '5px' }}><i className="fa-solid fa-circle-xmark"></i> Cancel</button></Link>
                    </div>
