...
export default function Slide() {
    ...
    $('#inent').on('hide.bs.dropdown', function (e) {
        if (e.clickEvent) {
          e.preventDefault();
        }
    });
        ...
        <>
            ...
            <div className='row'>
                <div className='col md-1'>
                    <div className="wrapper  ms-2 mt-5">
                                ...
                                <aside id="sidebar">
                                    <div className="h-100">
                                        ...
                                        <ul className="sidebar-nav">
                                            <li className="sidebar-item bg-white">
                                            ...
                                            <li className="sidebar-item  bg-white">
                                                <a href="#" className=" sidebar-link collapsed active" data-bs-toggle="collapse" data-bs-target="#inent"
                                                    aria-expanded="false" aria-controls="inent">
                                                    <i className="fa-solid fa-sliders pe-2"></i>
                                                    Inventory
                                                </a>
                                                <ul id="inent" className="sidebar-dropdown list-unstyled collapse ms-4 active" data-bs-parent="#sidebar">
                                                    <li className="sidebar-item">
                                                        <Link to='/catlist' className="sidebar-link"> Product Category</Link>
                                                    </li>
                                                    <li className="sidebar-item">
                                                        <Link to='/subcatlist' className="sidebar-link"> Product Sub Category</Link>
                                                    </li>
                                                    <li className="sidebar-item">
                                                        <Link to='/viewproduct' className="sidebar-link"> Product Group</Link>
                                                    </li>

                                                    <li className="sidebar-item">
                                                        <Link to='/procodelist' className="sidebar-link"> Product Code</Link>
                                                    </li>
                                                    <li className="sidebar-item">
                                                        <Link to="/addstore" className="sidebar-link"> Store and Location</Link>
                                                    </li>
                                                    <li className="sidebar-item">
                        ...
                        <div className="main">
                            <nav className="navbar navbar-expand px-3 ">
                                ...
                                <button className="btn" type="button" data-bs-theme="danger" onClick={add}>
