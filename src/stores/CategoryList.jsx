            ...
            <div className='row'>
                ...
                <div className='col-9 mt-5'>
                    <div className='' style={{marginLeft:'30px'}}>
                        <h3 className=''>Inventory<span className='fs-5 text-muted'>/PRODUCT CATEGORY LIST</span></h3>
                        <hr />
                        <Box sx={{ '& button': { m: 0.3 } }}>


                            <div style={{ marginTop: '30px' }}>
                                <Link to='/procat'><Button variant="contained" style={{ background: '#00ACFF', fontSize: '12px' }} size="small"> Add Category </Button></Link>
